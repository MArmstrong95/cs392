...
class histogram
{
	...
	ArrayList<Integer> arrayListNums;	// Arraylist created for adding values, regardless of number of lines in file
	int[] numArray;						// Array for storing the amount of numbers in each range
	int max;							// Max integer
	int grouping;						// Grouping variable to determine ranges
	...
	public histogram(int linecount)
	{
		...
		numArray = new int[10]; 					// Array for counting the number of numbers in each range
